...
import numpy as np
from cv2 import cvtColor, COLOR_RGB2BGR, VideoWriter_fourcc, VideoWriter, VideoCapture, CAP_PROP_FPS, \
...
def video_record():   # 录入视频
  ...
  video = VideoWriter('%s.avi' % name, fourcc, 24, (width, high)) # （文件名，编码器，帧率，视频宽高）
  #print('3秒后开始录制----')  # 可选
  #time.sleep(3)
  print('开始录制!')
  global start_time
