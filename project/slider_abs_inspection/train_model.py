...
from detection.fasterRCNN.datasets import coco, data_generator
from detection.fasterRCNN.datasets.utils import get_original_image
from detection.fasterRCNN.models.detectors import faster_rcnn
...
img_std = (1., 1., 1.)
batch_size = 1
train_dataset = coco.CocoDataSet('C:/data/Slider_abs/_coco_format', 'train',
                                 flip_ratio=0.5,
                                 pad_mode='fixed',
                                 mean=img_mean,
                                 std=img_std,
